const STRINGS = {
    en: {
        ...
        ecoLeaderboardTitle: "Eco-Leaderboard",
        ecoLeaderboardSubtitle: "Dhaka's top zero-plastic champions saving the environment",
        championsTableRank: "Rank",
        championsTableName: "Name",
        championsTableImpact: "Plastic Saved (g)",
        championsTableCredits: "Lifetime Credits",
        badgesTitle: "Your Eco-Milestone Badges",
        badgesSubtitle: "Unlock premium badges by making sustainable choices and returning containers",
        locked: "Locked",
        unlocked: "Unlocked!",
        you: "You",
        guestLeaderboardNotice: "Sign up or Sign in to track your personal impact and unlock badges!",
        zeroPlasticPioneerTitle: "Zero-Plastic Pioneer",
        zeroPlasticPioneerDesc: "Earn 100+ lifetime eco-credits by returns and orders.",
        amberAdvocateTitle: "Amber Advocate",
        amberAdvocateDesc: "Return 5+ amber glass containers for reuse.",
        monsoonWarriorTitle: "Monsoon Warrior",
        monsoonWarriorDesc: "Save a customized monsoon workout routine.",
        organicEpicureTitle: "Organic Epicure",
        organicEpicureDesc: "Order organic native grains or pasture proteins.",
        wellnessDiscipleTitle: "Wellness Disciple",
        wellnessDiscipleDesc: "Book a consultation with a certified wellness specialist."
    },
    bn: {
        shop: "শপ",
        ...
        ecoLeaderboardTitle: "ইকো-লিডারবোর্ড",
        ecoLeaderboardSubtitle: "পরিবেশ রক্ষায় ঢাকার শীর্ষ শূন্য-প্লাস্টিক চ্যাম্পিয়নরা",
        championsTableRank: "র‌্যাঙ্ক",
        championsTableName: "নাম",
        championsTableImpact: "সংরক্ষিত প্লাস্টিক (গ্রাম)",
        championsTableCredits: "আজীবন ক্রেডিট",
        badgesTitle: "আপনার ইকো-মাইলস্টোন ব্যাজ",
        badgesSubtitle: "টেকসই পছন্দ করে এবং পাত্র ফেরত দিয়ে প্রিমিয়াম ব্যাজগুলো আনলক করুন",
        locked: "লক করা",
        unlocked: "আনলক করা হয়েছে!",
        you: "আপনি",
        guestLeaderboardNotice: "আপনার ব্যক্তিগত পরিবেশগত প্রভাব ট্র্যাক করতে এবং ব্যাজগুলো আনলক করতে সাইন আপ বা সাইন ইন করুন!",
        zeroPlasticPioneerTitle: "শূন্য-প্লাস্টিক অগ্রগামী",
        zeroPlasticPioneerDesc: "রিটার্ন এবং অর্ডারের মাধ্যমে ১০০+ আজীবন ইকো-ক্রেডিট অর্জন করুন।",
        amberAdvocateTitle: "অ্যাম্বার সমর্থক",
        amberAdvocateDesc: "পুনর্ব্যবহারের জন্য ৫+ টি অ্যাম্বার গ্লাস কন্টেইনার ফেরত দিন।",
        monsoonWarriorTitle: "বর্ষা যোদ্ধা",
        monsoonWarriorDesc: "একটি কাস্টমাইজড বর্ষার ব্যায়ামের রুটিন সংরক্ষণ করুন।",
        organicEpicureTitle: "অর্গানিক ভোজনরসিক",
        organicEpicureDesc: "স্থানীয় জৈব শস্য বা চারণভূমির প্রোটিন অর্ডার করুন।",
        wellnessDiscipleTitle: "ওয়েলনেস অনুসারী",
        wellnessDiscipleDesc: "একজন প্রত্যয়িত স্বাস্থ্য বিশেষজ্ঞের সাথে সেশন বুক করুন।"
    }
};
...
export function applyShellI18n() {
    ...
    const map = {
        shop: '[data-page="shop"]',
        leaderboard: '[data-page="leaderboard"]',
